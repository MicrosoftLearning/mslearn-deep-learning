...
lab:
  ...
  module: 'Module: Deploy deep learning workloads to production with Azure Machine
    Learning'
  description: To deploy a model to an endpoint in Azure Machine Learning, you can
    use NVIDIA Triton Inference Server. In this exercise, you'll register an ONNX
    model that is already trained to the workspace. Deploying to an endpoint will
    be easy thanks to Triton's no-code-deployment option in Azure Machine Learning.
  duration: 10 minutes
  level: 100
  islab: true
  primarytopics:
